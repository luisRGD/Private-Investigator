...
2) To use the "FPEPlayerController", just drag it into your scene and you're done with the Player Controller step.
...
3a) FPESecondaryInteractionSoundPlayer prefab at offset location (0,0,0)
3c) FPEJournalSFX prefab at offset location (0,0,0)
...
Important Note: If you do not set a "Sound To Play On Interact", all other values for Secondary Sounds are ignored and no sound is played.
